<template>
  <NDrawer v-model:show="isActive" width="500" placement="right">
    <NDrawerContent closable title="更新记录">
      <div class="container">
        <NForm ref="formRef" :model="formValue" label-placement="left" label-width="49" label-align="center">
          <NGrid :cols="24" :x-gap="10">
            <NFormItemGi :span="12" label="版本" path="version1">
              <NSelect :options="logsOptions" v-model:value="formValue.version1"> </NSelect>
            </NFormItemGi>
            <NFormItemGi :span="12" path="version2" label="至">
              <NSelect :options="logsOptions?.reverse()" v-model:value="formValue.version2"></NSelect>
            </NFormItemGi>
            <NFormItemGi :span="24" label="类型" path="type">
              <NSelect multiple :options="logsTypeOptions" v-model:value="formValue.type"> </NSelect>
            </NFormItemGi>
          </NGrid>
        </NForm>
